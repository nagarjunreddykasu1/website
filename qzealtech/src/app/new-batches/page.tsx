...
export default function CourseSchedule() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      <main className="flex-1 bg-gray-50 px-10 py-24">
            ...
            <Table>
              ...
              <TableBody>
                {courses.map((course, index) => (
                  ...
                  >
                    <TableCell className="whitespace-pre-line font-medium">
                      {course.name}
                    </TableCell>
                    ...
                    <TableCell>
                      <Button variant="destructive" size="default" className="text-red-500 font-bold hover:text-white hover:bg-blue-500 rounded">
                        Register Now
                      </Button>
                    </TableCell>
                  </TableRow>
